...
public class AssertionChainingTests
{
    ...
    public void WhenAllAssertionsAreVerified_Chain_Should_Pass()
    {
        ...
        Verify.That(() => value.Should().Contain("ell").And.BeEqualTo("hello")).Passes();
    }
    ...
    {
        const string value = "hello";
        Verify.That(() => value.Should().Not.Contain("blah").And.BeEqualTo("hello")).Passes();
    }
    ...
    {
        const string value = "hello";
        Verify.That(() => value.Should().Contain("ell").And.Not.BeEqualTo("blah")).Passes();
    }
    ...
    {
        const string value = "hello";
        Verify.That(() => value.Should().Not.Contain("blah").And.Not.BeEqualTo("blah")).Passes();
    }
